...
<div class="col">
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="size_fractionr">
  </div>
</div>
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="cataloger_initials" maxlength="3">
</div>
</div>
<div class="col">
</div>
...
<div class="col">
  ...
  <div class="form-group">
    <label for="photograph">Choose image</label>
...
<div class="col">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="collection_issue_note" maxlength="400" placeholder="Collection issue note">
  </div>
</div>
