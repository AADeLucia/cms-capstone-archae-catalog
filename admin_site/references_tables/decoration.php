...
$sql = "SELECT * FROM decorations ORDER BY decoration_name";
if ($result = $conn->query($sql)){
  if($result->num_rows > 0){
    echo "<table id = \"catalog_browse\" class=\"table\">";
        echo "<tr>";
            echo "<th><u>Decoration Name</th>";
            echo "<th><u>Associated Surface Treatment</th>";
    ...
    while($row = $result->fetch_array()){
        ...
        echo "<tr>";
            ...
            echo "<td>" . $row['associated_surface'] . "</td>";
