...
<head>
  ...
  $(document).ready(function(){
    $("#search_submit").click(function(){
      $("#browse_results").load("catalog_query_by_id.php");
    });
  });
  </script>
</head>
    ...
    <div class="row">
      ...
      <div class="col" id="content_section">
        ...
        <form class="form-inline" method="post" action="">
          ...
          <button type="submit" id="search_submit" name="search_submit" class="btn btn-primary">Search</button>
        </form>
        <hr />
        ...
        <form method="post" action="">
          ...
          <div class="row align-items-center">
            <div class="col">
              <button type="submit" id="browse_submit" name="browse_submit" class="btn btn-primary">Search</button>
            </div>
          </div>
        </form>
